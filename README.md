# [routing.earth](https://routing-earth.com) challenge for QGIS Network Analyst tutorials

> [!NOTE]
> This is an experiment. It's fun (for us) and might provide the wider QGIS community with helpful network analysis tutorials for open source software with open data!

**Main goal**: convert [ESRI Network Analyst](https://www.esri.com/de-de/arcgis/products/arcgis-network-analyst/overview) subscribers to use [QGIS](https://qgis.org) and our [network analysis plugin](https://routing-earth.com/software/qgis-plugin) on top of [OSM](https://openstreetmap.org) data.

Think that's cheeky? Probably!

## The challenge

To make a transition easy enough, we'd like to end up replicating the [public and free tutorials](https://doc.esri.com/en/arcgis-pro/latest/help/analysis/networks/network-analyst-tutorials.html).
...
- **human first**: AI is fine to use as inspiration, but don't submit slop!
- **logical flow**: we don't want identical tutorials in terms of didactics. The tutorial should make sense in the QGIS/Valhalla/OSM world.
- **no AI slop**: you know, no AI slop.

## Resolving conflicts

It's first come, first serve. There shouldn't be any conflicts.

## Contact

Comment on this repo's issues or PRs on Github. Don't email us unless it's concerning privacy related details. It's supposed to be open tutorials for open software running on open data. We want the same transparency here, so everyone benefits.
